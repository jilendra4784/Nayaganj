...
class ReturnProductAdapter(
    val context: Context,
    val app: Nayaganj,
    val products: List<OrderDetailModel.OrderDetails.Product>, val productSelectListener : ProductSelectListener,
) : RecyclerView.Adapter<ReturnProductAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.tvUnit.text =product.variantUnitQuantity+" "+product.variantUnit

...
class CouponListAdapter(val context: Context,val applyCouponInterface : ApplyCouponInterface,private val couponList: List<CouponModel.PromoCode>,val promoCodeId:String ,val amount: Double) :

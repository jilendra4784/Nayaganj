...
class DeliveredOrderDetailAdapter(val products: List<OrderDetailModel.OrderDetails.Product>): RecyclerView.Adapter<DeliveredOrderDetailAdapter.MyViewHolder>() {
    class MyViewHolder(val binding: ProductDetailAdapterRowBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onCreateViewHolder(
        ...
        return MyViewHolder(ProductDetailAdapterRowBinding.inflate(LayoutInflater.from(parent.context),parent,false))
    }
